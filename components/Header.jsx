        ...
        <div>
            <div className='px-5 lg:px-8 flex justify-between items-center bg-[#333333] text-[#cccccc]'>
                ...
                <div className='flex gap-x-[1px]'>
                    <HiOutlineUserCircle className='cursor-pointer' onClick={handleUserIconClick} size={20} />
                    ...
                    <div className='flex justify-center items-center flex-wrap'>
                        <div className='md:w-4/12 w-full'>
                            <div className='flex flex-col justify-center items-center md:items-start'>
                                <Image className='w-[200px] h-[120px]' alt='logo' src={logo} />
                                <h2 className='text-[#cccccc]'>مباشر مصر</h2>
                            </div>
                        </div>
                        <div className='md:w-8/12 w-full hidden msd:block'>
                            <div className='w-full flex justify-end'>
                                <Image alt='img' src={adver_image} />
                            </div>
                        </div>
